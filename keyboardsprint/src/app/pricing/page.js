    ...
    <div className={styles.pricingPage}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        ...
        <div className={styles.faqSection}>
          ...
          <div className={styles.faqItem}>
            <h4>What makes KeyboardSprint different from a regular text editor?</h4>
            <p>Regular editors focus on management and formatting. KeyboardSprint focuses entirely on momentum. Between the &quot;Fog of War&quot; and the &quot;Burn&quot; timer, we provide a psychological safe space where editing is impossible, leaving you with no choice but to create.</p>
          </div>
