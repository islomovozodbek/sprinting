...
-- Daily submission voting system
...
-- Removed: "Users can create daily prompt records" - this should be done via RPC or server-side admin to avoid client-side spam.
...
-- Removed: "Users can update votes on daily submissions" USING (true) - security hole, use RPC instead.
...
-- Removed: "System can insert notifications" USING (true) - security hole, functions bypass RLS so it's not needed.
